...
\midrule
Raw model-run data & git commit \texttt{9fa7576} \\
Manuscript, figures, and statistics & release \texttt{v1.0.0} \\
Archived snapshot (all versions) & Zenodo \texttt{10.5281/zenodo.20722369} \\
\bottomrule
\end{tabular}
\end{center}
...
This study used openly licensed dental images and clinician-authored rubrics. It did not use patient records or protected health information. No ethics approval or consent for publication was required, because the study used only openly licensed public images and no patient records or newly collected human-subject data. The results should not be interpreted as validating any model for autonomous diagnosis, treatment planning, or patient-specific clinical decision-making.
